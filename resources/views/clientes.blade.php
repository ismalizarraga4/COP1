			...
			<div class="modal-content mod_ctl">
				...
				<div class="modal-body">
					...
					<div class="form_cliente">
						<p class="txt_fctl">Nombre</p><input id="nombre_ctl" class="form-control inpt_ctl" type="text" autocomplete="off">
						<p class="txt_fctl">Apellido Paterno</p><input id="apellidoP_ctl" class="form-control inpt_ctl" type="text" autocomplete="off">
						<p class="txt_fctl">Apellido Materno</p><input id="apellidoM_ctl" class="form-control inpt_ctl" type="text" autocomplete="off">
						<p class="txt_fctl">R.F.C.</p><input id="rfc_ctl" class="form-control inptrfc_ctl" type="text" autocomplete="off">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content mod_ctl">
				...
				<div class="modal-body">
					...
					<div class="form_cliente">
						<p class="txt_fctl">Nombre</p><input id="nombre_ectl" class="form-control inpt_ctl" type="text" autocomplete="off">
						<p class="txt_fctl">Apellido Paterno</p><input id="apellidoP_ectl" class="form-control inpt_ctl" type="text" autocomplete="off">
						<p class="txt_fctl">Apellido Materno</p><input id="apellidoM_ectl" class="form-control inpt_ctl" type="text" autocomplete="off">
						<p class="txt_fctl">R.F.C.</p><input id="rfc_ectl" class="form-control inptrfc_ctl" type="text" autocomplete="off">
