			...
			<div class="modal-content mod_ctl">
				...
				<div class="modal-body">
					...
					<div class="form_cliente">
						<p class="txt_fctl">Descripci&oacute;n</p><input id="descripcion_art" class="form-control inpt_ctl" type="text" autocomplete="off">
						<p class="txt_fctl">Modelo</p><input id="modelo_art" class="form-control inpt_ctl" type="text" autocomplete="off">
						<p class="txt_fctl">Precio</p><input id="precio_art" class="form-control inptpr_art snumero" type="text" autocomplete="off">
						<p class="txt_fctl">Existencia</p><input id="existencia_art" class="form-control inptex_art snumero" type="text" autocomplete="off">
					</div>
				</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content mod_ctl">
				...
				<div class="modal-body">
					...
					<div class="form_cliente">
						<p class="txt_fctl">Descripci&oacute;n</p><input id="descripcion_eart" class="form-control inpt_ctl" type="text" autocomplete="off">
						<p class="txt_fctl">Modelo</p><input id="modelo_eart" class="form-control inpt_ctl" type="text" autocomplete="off">
						<p class="txt_fctl">Precio</p><input id="precio_eart" class="form-control inptpr_art snumero" type="text" autocomplete="off">
						<p class="txt_fctl">Existencia</p><input id="existencia_eart" class="form-control inptex_art snumero" type="text" autocomplete="off">
